  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className="absolute left-8 sm:left-16 md:left-32 bottom-32 sm:bottom-52 hidden sm:block animate-fade-in-left"
        ...
        <div
          className="absolute left-20 sm:left-40 md:left-64 bottom-10 sm:bottom-20 hidden sm:block animate-fade-in-left"
        ...
        <div
          className="absolute right-8 sm:right-16 md:right-32 bottom-32 sm:bottom-52 hidden sm:block animate-fade-in-right"
          style={{ animationDelay: "0.15s" }}
        >
          <Image
            src="/images/cursor.png"
        ...
        <div
          className="absolute right-20 sm:right-40 md:right-64 bottom-10 sm:bottom-20 hidden sm:block animate-fade-in-right"
          style={{ animationDelay: "0.25s" }}
        >
          <Image
            src="/images/cursor.png"
        ...
        <div className="mx-auto max-w-2xl md:py-8 py-8 sm:py-16">
          ...
          <div className="text-center animate-fade-in-up">
            ...
            <p
              className="mt-4 sm:mt-8 font-semibold text-lg sm:text-xl leading-7 sm:leading-8 text-gray-400 max-w-2xl mx-auto px-2 animate-fade-in-up"
            ...
            <div
              className="mt-8 sm:mt-10 flex items-center justify-center gap-x-4 sm:gap-x-6 animate-fade-in-up"
              style={{ animationDelay: "0.15s" }}
            >
              <a
                href="#demo"
